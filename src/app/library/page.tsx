...
//
//   logged out              → /video_games (Robert's shelf, the public demo)
...
// the CDN. Quarantining the cookie read here keeps / and /video_games fully
