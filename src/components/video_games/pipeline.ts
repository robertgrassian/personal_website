...
// compareIso, foldForSearch and foldedName live in textMatch.ts so the test
// suite can reach them; re-exported here because this is where callers look.
import { compareIso, foldForSearch, foldedName } from "./textMatch";
export { compareIso, foldForSearch, foldedName };
